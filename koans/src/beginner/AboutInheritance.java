...
public class AboutInheritance {
    ...
    public void methodOverloadingUsingPolymorphism() {
        ...
        // assertEquals(max.canFetch(), true);
        // assertEquals(barney.canFetch(), false); // They cannot fetch until casted to orignal class. Because the animal class does not have a fetch method. If fetch had been defined, they would have been able to do so.  
    }
